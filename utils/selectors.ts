...
export const pixelGameSelectors = {
  ...
  taskBots: ["div._info_layout_bt2qf_1 > div > div:nth-child(1) > div > div", "#jetton > div > div"],
  taskNotCompleted: "div._row_main_information_bt2qf_103 > div:nth-child(2)",
  tasks: [
    // Special tasks:
    "div._info_layout_bt2qf_1 > div > div:nth-child(9) > div > div", //Me bot
    // "#telegramPremium",
    "#leagueBonusSilver",
    "#leagueBonusGold",
    "#leagueBonusPlatinum",
